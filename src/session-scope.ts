...
export function readCurrentSession(value: unknown): string | undefined {
 ...
 */
export function withSessionParam(path: string, session: string | undefined): string {
...
export function sessionField(session: string | undefined): { session?: string } {
