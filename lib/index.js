	...
	const routes = [
		...
		},
		{
			...
			handler: handle("GET", async () => {
				...
				let counters;
				try {
					const { reaperDiagnostics, controllerCounters } = await import("./mcpcall-Dj-KalA8.mjs").then((n) => n.c);
