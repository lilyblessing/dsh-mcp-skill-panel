...
import { a as rowDisabledState, c as syncPresetFiles, n as buildSkillMd, o as setRowFlag, r as isValidSkillName, s as setSkillFlag, t as EDITABLE_CONFIG_KEYS } from "./preset-IPgDnJPU.mjs";
...
async function toggleMcp(deps, entryId, disabled, applyMode) {
	...
	if (!entry || gatewayServerOfEntryId(entryId) !== null) {
		...
		if (found) {
			...
			try {
				const { rowDisabledState } = await import("./preset-IPgDnJPU.mjs").then((n) => n.i);
