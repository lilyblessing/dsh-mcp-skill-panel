import { C as scanWorkspaceMcp, D as serverOfMcp$1, E as saveCatalog, O as snapshotFromSchemas, S as remountWorkspace, T as loadCatalog, _ as getActiveWorkspace, a as gatewayCall, b as projectServerOwner, d as normalizeToolName, f as disabledToolsOf, g as setToolDisabled, h as loadDisabledTools, i as createMcpCallController, l as msgOf, m as isToolDisabled, n as MCP_CALL_TOOL, o as installMcpControlTools, p as installToolDisableFilter, r as MCP_SEARCH_TOOL, s as inventoryTraceDiag, t as CONTROL_TOOL_NAMES, u as normalizeArguments, v as installProjectMcp, w as messageOf, x as rebuildOwnersFromState, y as projectServerName } from "./mcpcall-U2kCEOhI.mjs";
...
import { a as rowDisabledState, c as syncPresetFiles, n as buildSkillMd, o as setRowFlag, r as isValidSkillName, s as setSkillFlag, t as EDITABLE_CONFIG_KEYS } from "./preset-B41rPQ7h.mjs";
...
async function toggleMcp(deps, entryId, disabled, applyMode) {
	...
	if (!entry || gatewayServerOfEntryId(entryId) !== null) {
		...
		if (found) {
			...
			try {
				const { rowDisabledState } = await import("./preset-B41rPQ7h.mjs").then((n) => n.i);
	...
	const routes = [
		...
		},
		{
			...
			handler: handle("GET", async () => {
				...
				let counters;
				try {
					const { reaperDiagnostics, controllerCounters } = await import("./mcpcall-U2kCEOhI.mjs").then((n) => n.c);
