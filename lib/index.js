import { A as snapshotFromSchemas, C as rebuildOwnersFromState, D as loadCatalog, E as messageOf, O as saveCatalog, S as projectServerOwner, T as scanWorkspaceMcp, _ as setToolDisabled, a as gatewayCall, b as installProjectMcp, d as normalizeToolName, f as disabledToolsOf, g as resolveToolBulkTargets, h as loadDisabledTools, i as createMcpCallController, k as serverOfMcp$1, l as msgOf, m as isToolDisabled, n as MCP_CALL_TOOL, o as installMcpControlTools, p as installToolDisableFilter, r as MCP_SEARCH_TOOL, s as inventoryTraceDiag, t as CONTROL_TOOL_NAMES, u as normalizeArguments, v as setToolsDisabledBulk, w as remountWorkspace, x as projectServerName, y as getActiveWorkspace } from "./mcpcall-DXOkgm-v.mjs";
	...
	const routes = [
		...
		},
		{
			...
			handler: handle("GET", async () => {
				...
				let counters;
				try {
					const { reaperDiagnostics, controllerCounters } = await import("./mcpcall-DXOkgm-v.mjs").then((n) => n.c);
