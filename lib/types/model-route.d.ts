 ...
 */
export declare function activeRouteView(decision: RouteDecision): ActiveRouteView;
 ...
 */
export declare function fetchProviderCatalog(llm: LlmLike | undefined): Promise<ProviderCatalogEntry[]>;
/**
 ...
 */
export declare function modelsCacheFresh(fetchedAt: number | null, now: number, ttlMs: number): boolean;
export {};
