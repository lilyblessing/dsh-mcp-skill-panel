...
function RuntimeInventorySection(props) {
	...
	const load = (0, react.useCallback)(() => {
		setError(null);
		fetch("/api/runtime-inventory/state").then((res) => res.json()).then((body) => {
	...
	const post = (0, react.useCallback)((path, payload, key, optimistic) => {
		setBusy((prev) => ({
			...prev,
			[key]: true
		}));
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
					...
					style: C.meta,
					children: state ? `${t("ri.preset")}: ${state.preset ?? "—"} · ${t("ri.session")}: ${state.sessionId ?? "—"}` : ""
			...
			state && tab === "mcp" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(McpPanel, {
				state,
				t,
				busy,
				onToggle: toggleMcp,
			...
			state && tab === "skill" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SkillPanel, {
				state,
				t,
				busy,
