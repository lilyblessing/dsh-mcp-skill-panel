...
function RuntimeInventorySection(props) {
	...
	const loadMcp = (0, react.useCallback)(() => {
		const seq = ++mcpSeq.current;
		setError(null);
		fetch("/api/mcp-skill-panel/state?part=mcp").then((res) => res.json()).then((body) => {
	...
	const loadSkills = (0, react.useCallback)(() => {
		const seq = ++skillsSeq.current;
		setError(null);
		fetch("/api/mcp-skill-panel/state?part=skills").then((res) => res.json()).then((body) => {
			if (!body.ok || !body.state) throw new Error(body.error ?? "bad response");
	...
	const post = (0, react.useCallback)((path, payload, key, onOk) => {
		setBusy((prev) => ({
			...prev,
			[key]: true
		}));
	...
	const toggleMcp = (row) => {
		post("/api/runtime-inventory/mcp/toggle", {
			entryId: row.entryId,
			disabled: !row.disabled
		}, `mcp:${row.rowId}`, () => loadMcp());
	};
	...
	const toggleSkill = (row) => {
		post("/api/runtime-inventory/skill/toggle", {
			name: row.name,
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
					...
					type: "button",
					style: C.refresh,
					onClick: () => tab === "mcp" ? loadMcp() : loadSkills(),
			...
			view && tab === "mcp" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AutoManageCard, {
				on: view.autoManage,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("h3", {
				style: C.cardTitle,
				children: [t("ri.autoManageTitle"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: C.badge(on ? "var(--dsw-alias-state-success-primary)" : "var(--dsw-alias-label-tertiary)", on ? "var(--dsw-alias-state-success-tertiary)" : "var(--dsw-alias-fill-l2)"),
		...
		state.mcp.map((row) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("h3", {
							...
							children: [
								row.serverName,
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: C.badge(st.color, st.bg),
									children: st.label
								}),
								row.modelVisible ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: C.badge("var(--dsw-alias-state-info-primary, #4a90d9)", "var(--dsw-alias-state-info-tertiary, rgba(74,144,217,0.15))"),
									children: t("ri.modelVisible")
								}) : !row.disabled && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: C.badge("var(--dsw-alias-label-tertiary)", "var(--dsw-alias-fill-l2)"),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: C.hint,
						children: row.disabled ? t("ri.toggleOnHint") : t("ri.toggleOffHint")
					})
				]
			}, row.entryId);
		})
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("h3", {
							style: C.cardTitle,
							children: [row.name, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: C.badge(visible ? "var(--dsw-alias-state-success-primary)" : "var(--dsw-alias-label-tertiary)", visible ? "var(--dsw-alias-state-success-tertiary)" : "var(--dsw-alias-fill-l2)"),
