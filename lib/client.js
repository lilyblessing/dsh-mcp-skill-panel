...
function RuntimeInventorySection(props) {
	...
	const loadMcp = (0, react.useCallback)(() => {
		setError(null);
		fetch("/api/runtime-inventory/state?part=mcp").then((res) => res.json()).then((body) => {
	...
	const loadSkills = (0, react.useCallback)(() => {
		setError(null);
		fetch("/api/runtime-inventory/state?part=skills").then((res) => res.json()).then((body) => {
			if (!body.ok || !body.state) throw new Error(body.error ?? "bad response");
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			view && tab === "mcp" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(McpPanel, {
				state: view,
				t,
				busy,
				onToggle: toggleMcp,
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("h3", {
							style: C.cardTitle,
							children: [row.serverName, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
